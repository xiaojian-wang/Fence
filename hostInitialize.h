...
// OnlineScheme: 
double get_lambda2_utilization(double, double);
double get_lambda2_cost(double);
double get_lambda1_utilization(double, double, double); //Note: seems no use...
double get_lambda1_cost(double);
...
vector<vector<int>> getKPaths2(int sender, int receiver, int k); // OnlineScheme: 
