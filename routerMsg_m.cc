...
const IntVector& routerMsg::getRoute() const
{
    return this->route;
}

void routerMsg::setRoute(const IntVector& route)
{
    this->route = route;
}

int routerMsg::getHopCount() const
{
    return this->hopCount;
}

void routerMsg::setHopCount(int hopCount)
{
...
routerMsgDescriptor::routerMsgDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(routerMsg)), "omnetpp::cPacket")
{
    propertyNames = nullptr;
}
...
bool routerMsgDescriptor::doesSupport(omnetpp::cObject *obj) const
{
    return dynamic_cast<routerMsg *>(obj)!=nullptr;
}

const char **routerMsgDescriptor::getPropertyNames() const
{
    if (!propertyNames) {
...
int routerMsgDescriptor::findField(const char *fieldName) const
{
    ...
    if (strcmp(fieldName, "route") == 0) return baseIndex + 0;
    if (strcmp(fieldName, "hopCount") == 0) return baseIndex + 1;
    if (strcmp(fieldName, "messageType") == 0) return baseIndex + 2;
    return base ? base->findField(fieldName) : -1;
}

const char *routerMsgDescriptor::getFieldTypeString(int field) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
const char *routerMsgDescriptor::getFieldProperty(int field, const char *propertyName) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
int routerMsgDescriptor::getFieldArraySize(omnetpp::any_ptr object, int field) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
    ...
    routerMsg *pp = omnetpp::fromAnyPtr<routerMsg>(object); (void)pp;
    switch (field) {
        default: return 0;
    }
}

void routerMsgDescriptor::setFieldArraySize(omnetpp::any_ptr object, int field, int size) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
    ...
    routerMsg *pp = omnetpp::fromAnyPtr<routerMsg>(object); (void)pp;
    switch (field) {
        default: throw omnetpp::cRuntimeError("Cannot set array size of field %d of class 'routerMsg'", field);
    }
}

const char *routerMsgDescriptor::getFieldDynamicTypeString(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
std::string routerMsgDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
void routerMsgDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
    ...
    switch (field) {
        ...
        default: throw omnetpp::cRuntimeError("Cannot set field %d of class 'routerMsg'", field);
    }
}

omnetpp::cValue routerMsgDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
    ...
    routerMsg *pp = omnetpp::fromAnyPtr<routerMsg>(object); (void)pp;
    switch (field) {
        case FIELD_route: return omnetpp::toAnyPtr(&pp->getRoute()); break;
        case FIELD_hopCount: return pp->getHopCount();
        case FIELD_messageType: return pp->getMessageType();
        default: throw omnetpp::cRuntimeError("Cannot return field %d of class 'routerMsg' as cValue -- field index out of range?", field);
    }
}

void routerMsgDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
...
const char *routerMsgDescriptor::getFieldStructName(int field) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
    ...
    switch (field) {
        case FIELD_route: return omnetpp::opp_typename(typeid(IntVector));
        default: return nullptr;
    };
}

omnetpp::any_ptr routerMsgDescriptor::getFieldStructValuePointer(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
void routerMsgDescriptor::setFieldStructValuePointer(omnetpp::any_ptr object, int field, int i, omnetpp::any_ptr ptr) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
