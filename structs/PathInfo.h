...
struct PathInfo{
    public:
        ...
        simtime_t lastSendTime = 0; // FIXME:whats the last SendTime?? 
        ...
        double nValue = 0; // number of txns sent to a particular destination on this path Note: number of txns
