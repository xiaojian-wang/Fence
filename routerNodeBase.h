...
{
    protected:
        unordered_map<int, PaymentChannel> nodeToPaymentChannel = {}; // Note: node to payment channel, key is node, me to this node
        unordered_map<int, PaymentChannel> nodeFromPaymentChannel = {}; // OnlineScheme: a path, in gate Question: how to update this map? 
