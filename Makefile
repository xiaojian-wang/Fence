#
# OMNeT++/OMNEST Makefile for OnlineFeeBase_TON_revision_updatefrequency
#
...
TARGET_DIR = .
TARGET_NAME = OnlineFeeBase_TON_revision_updatefrequency$(D)
