#!/bin/bash
Thread_num=44 # the server has 48 cores //12.29 04 has 16 cores
Tmp_fifo=/tmp/$$.fifo
mkfifo $Tmp_fifo
exec 6<> $Tmp_fifo
rm -f $Tmp_fifo
...
batch_num=13000 # for J7 group version
...
# config_list="C1 C2 C3 C4"
config_list="C1 C2 C3 C4"
ini='workload_TON_0.00015_updatefrequency.ini'
